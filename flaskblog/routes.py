...
def send_reset_email(user):
    ...
    msg.body = f'''To reset password, visit the following link: {url_for("reset_token", token=token, _external=True)} If you did not make this request then please ignore this email'''
    mail.send(msg)
